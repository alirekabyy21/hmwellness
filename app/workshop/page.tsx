              ...
              <CardContent className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">3 hours intensive session</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <MapPin className="h-5 w-5 text-purple-600 mr-3" />
                  <div>
                    <p className="font-medium">New Cairo</p>
                    <p className="text-sm text-gray-600">Exact location will be shared via email</p>
                  </div>
                </div>
                <div className="flex items-center">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center">
                  <div className="text-3xl font-bold text-purple-900 mb-2">600 EGP</div>
                  <p className="text-gray-600 mb-4">Early bird special: 450 EGP</p>
